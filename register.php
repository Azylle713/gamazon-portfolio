...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO sign_in_tbl (last_name, first_name, middle_name, email, lot_number, block_number, street, subdivision, province, city_municipality, barangay, country, phone, password) 
...
<div class="background">
    ...
    <div class="form-btn" style="text-align: center;">
    Done?<a href="index.php"> <span class="login-link">Back to Home.</span></a>
    </div>
</div>
